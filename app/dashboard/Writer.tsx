        ...
        return(
            ...
            <div className = {fontSans.className}>
                    ...
                    <div className = 'inline-flex pt-8 max-sm:flex-col max-sm:flex max-sm:justify-center'>
                        ...
                        <div className = 'h-40 w-96 border-1 border-gray-700 rounded-lg p-6 mr-8 '>
                            ...
                            <div>
                                <div className = 'inline-flex gap-2 py-2'> <div className = 'text-gray-500'>Owner / Admin :</div><div>{owner}</div></div>
                                
                            </div>
                            <Button variant = 'flat' color = 'danger' className = 'my-1' onClick = {leaveMagazine}>Leave</Button>
                        </div>
                        </div>
                        ...
                        <div>
                          <div className = 'pl-6 pt-6 inline-flex'><UserButton /> <div className = ' px-4 text-lg inline-flex'>{user?.firstName} <div className = 'font-thin pl-4'>({role})</div></div></div>
                        </div>
            ...
            <Card className="max-w-[300px] h-[335px] p-4 bg-transparent border-1 border-gray-800">
                ...
                <CardBody className = 'py-4'>
                    <div className = 'font-thin'>Your submission will be forwarded to the editor, then to the admin for further verification, and finally posted.</div>
                </CardBody>
                <Divider />
                <CardFooter className = 'py-4'>
                    <Link href = '/createPost'><Button color = 'primary' variant = 'flat'>Create Post</Button></Link>
                </CardFooter>
            </Card>
            </div>
            </div>
