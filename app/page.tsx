    ...
    <div className={fontSans.className}>
      <div className="inline-flex max-sm:flex-col">
        <div className="py-20 w-1/2 mx-4">
          <div className="text-4xl  font-bold inline-flex gap-2">
            Create
            <div className="text-4xl font-bold text-blue-400">beautiful</div>
          </div>
          <div className="text-4xl font-bold">
            e-magazine designs regardless of your experience
          </div>

          <div className=" py-6 font-thin flex align-middle text-gray-400 ">
          ...
          <div className="py-4 flex ">
            ...
            <div className="inline-flex px-8">
              <Link href="https://github.com/Baryonae/emcams.git">
                <Button
                  color="primary"
                  variant="flat"
      ...
      <div
        id="#reviews"
        className="w-full bg-gradient-to-r from-transparent via-[#00091b] to-transparent h-full flex justify-center border-t border-b border-gray-800"
      >
          ...
          {datas.map((data) => (
            ...
            >
              ...
              >
                ...
                <CardBody>
                  <div className="mx-4">{data.body}</div>
                </CardBody>
              </Card>
            </div>
          ))}
      ...
      <div className="px-8 py-20" id="title">
        <div className="text-4xl font-bold">Some Title</div>
      </div>
    </div>
  );
}
